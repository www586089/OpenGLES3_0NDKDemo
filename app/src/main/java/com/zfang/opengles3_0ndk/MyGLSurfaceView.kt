...
class MyGLSurfaceView @JvmOverloads constructor(
        ...
        if (e.pointerCount == 1) {
            ...
            if (currentTimeMillis - mLastMultiTouchTime > 200) {
                ...
                when (gLRender.sampleType) {
                    ...
                    SAMPLE_LEARN_PHONG_TEXTURE,SAMPLE_MULTILIGHTS, SAMPLE_INSTANCING_ARRAY, SAMPLE_ASTEROID_ID, SAMPLE_ASTEROID_ARRAY,SAMPLE_SHADOW_MAPPING_DEPTH,
                    ...
                    SAMPLE_TYPE_KEY_UBO, SAMPLE_TYPE_KEY_TEXT_RENDER, SAMPLE_PARALLAX_MAPPING, HDR_TOME_MAPPING, SAMPLE_BLOOM_BLUR, SAMPLE_Deferr_Shading -> {
    ...
    override fun onScale(detector: ScaleGestureDetector): Boolean {
        when (gLRender.sampleType) {
            SAMPLE_TYPE_COORD_SYSTEM, SAMPLE_TYPE_BASIC_LIGHTING, SAMPLE_TYPE_INSTANCING, SAMPLE_TYPE_3D_MODEL,
            SAMPLE_TYPE_KEY_VISUALIZE_AUDIO, SAMPLE_TYPE_KEY_TEXT_RENDER, SAMPLE_CUBE_MAP_TEXTURE -> {
