        ...
        if (e.pointerCount == 1) {
            ...
            if (currentTimeMillis - mLastMultiTouchTime > 200) {
                ...
                when (gLRender.sampleType) {
                    SAMPLE_TYPE_FBO_LEG, SAMPLE_TYPE_COORD_SYSTEM, SAMPLE_TYPE_BASIC_LIGHTING, SAMPLE_TYPE_TRANS_FEEDBACK, SAMPLE_TYPE_MULTI_LIGHTS, SAMPLE_TYPE_DEPTH_TESTING, SAMPLE_TYPE_INSTANCING, SAMPLE_TYPE_STENCIL_TESTING, SAMPLE_TYPE_PARTICLES, SAMPLE_TYPE_SKYBOX, SAMPLE_TYPE_3D_MODEL, SAMPLE_TYPE_PBO, SAMPLE_TYPE_KEY_VISUALIZE_AUDIO, SAMPLE_TYPE_KEY_UBO, SAMPLE_TYPE_KEY_TEXT_RENDER -> {
