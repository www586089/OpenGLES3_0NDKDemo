...
//    m_pModel = new Model(path + "/model/lucy_heartfilia_praying/scene.gltf");
//    m_pModel = new Model(path + "/model/skull/scene.gltf");
    m_pModel = new Model(path + "/model/chinese_ancient_game_girl_role/scene.gltf");
    //m_pModel = new Model(path + "/model/poly/Apricot_02_hi_poly.obj");
    //m_pModel = new Model(path + "/model/backpack/backpack.obj");
    //m_pModel = new Model(path + "/model/moon/scene.gltf");//moon
//    m_pModel = new Model(path + "/model/artificial_womb/scene.gltf");//error
//    m_pModel = new Model(path + "/model/girl_swimsuit/scene.gltf");
//    m_pModel = new Model(path + "/model/black_dragon_with_idle_animation/scene.gltf");
...
void Model3DSample::UpdateMVPMatrix(glm::mat4 &mvpMatrix, int angleX, int angleY, float ratio) {
    LOGE("Model3DSample::UpdateMVPMatrix angleX = %d, angleY = %d, ratio = %f", angleX, angleY, ratio);
    angleX = angleX % 360;
    angleY = angleY % 360;
...
void Model3DSample::updateTransformMatrix(float rotateX, float rotateY, float scaleX, float scaleY) {
    ...
    LOGE("Model3DSample::updateTransformMatrix, rotateX = %f", rotateX);
