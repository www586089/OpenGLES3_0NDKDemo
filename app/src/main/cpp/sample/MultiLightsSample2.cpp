...
MultiLightsSample2::MultiLightsSample2() {
...
void MultiLightsSample2::init() {
    ...
    if (m_ProgramObj) {
        ...
        LOGE("MultiLightsSample2::Init create program fail");
        return;
    }
...
void MultiLightsSample2::loadImage(NativeImage *pImage) {
    LOGE("MultiLightsSample2::LoadImage pImage = %p", pImage->ppPlane[0]);
    if (pImage) {
...
void MultiLightsSample2::draw(int screenW, int screenH) {
    LOGE("MultiLightsSample2::Draw()");
...
void MultiLightsSample2::destroy() {
    if (m_ProgramObj) {
...
void MultiLightsSample2::UpdateMVPMatrix(glm::mat4 &mvpMatrix, int angleX, int angleY, float ratio) {
    //No implement
}

void MultiLightsSample2::UpdateMatrix(glm::mat4 &mvpMatrix, glm::mat4 &modelMatrix, int angleXRotate,
                                      int angleYRotate, float scale, glm::vec3 transVec3, float ratio) {
    LOGE("MultiLightsSample2::UpdateMatrix angleX = %d, angleY = %d, ratio = %f", angleXRotate,
            angleYRotate, ratio);
...
void MultiLightsSample2::updateTransformMatrix(float rotateX, float rotateY, float scaleX, float scaleY) {
