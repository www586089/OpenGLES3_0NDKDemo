...
InstancingAsteroidIDSample::InstancingAsteroidIDSample() {
    m_AngleX = 0;
    m_AngleY = 0;
...
void InstancingAsteroidIDSample::init() {
...
void InstancingAsteroidIDSample::loadImage(NativeImage *pImage) {
    LOGE("InstancingAsteroidIDSample::LoadImage pImage = %p", pImage->ppPlane[0]);
}

void InstancingAsteroidIDSample::draw(int screenW, int screenH) {
    if(planet == nullptr || m_pShader == nullptr) return;
    LOGE("InstancingAsteroidIDSample::Draw()");
...
void InstancingAsteroidIDSample::destroy() {
    LOGE("InstancingAsteroidIDSample::Destroy");
    if (planet != nullptr) {
        planet->Destroy();
        delete planet;
        planet = nullptr;
...
void InstancingAsteroidIDSample::UpdateMVPMatrix(glm::mat4 &mvpMatrix, int angleX, int angleY, float ratio) {
    LOGE("InstancingAsteroidIDSample::UpdateMVPMatrix angleX = %d, angleY = %d, ratio = %f", angleX, angleY, ratio);
    angleX = angleX % 360;
    angleY = angleY % 360;
...
void InstancingAsteroidIDSample::updateTransformMatrix(float rotateX, float rotateY, float scaleX, float scaleY) {
    GLSampleBase::updateTransformMatrix(rotateX, rotateY, scaleX, scaleY);
    LOGE("InstancingAsteroidIDSample::updateTransformMatrix, rotateX = %f", rotateX);
