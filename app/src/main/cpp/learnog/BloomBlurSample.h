...
#ifndef OPENGLES3_0NDKDEMO_BLOOMBLURSAMPLE_H
#define OPENGLES3_0NDKDEMO_BLOOMBLURSAMPLE_H
...
class BloomBlurSample : public LightingSampleBase {
public:
    BloomBlurSample();

    virtual ~BloomBlurSample();
...
#endif //OPENGLES3_0NDKDEMO_BLOOMBLURSAMPLE_H
