...
#ifndef OPENGLES3_0NDKDEMO_SHADER_H
#define OPENGLES3_0NDKDEMO_SHADER_H
...
//            LOGE("Read Shader End");
//            LOGE("vertexCode = %s, fragmentCode = %s", vertexCode.c_str(), fragmentCode.c_str());
//        } catch (std::ifstream::failure &e) {
//            LOGE("Read Shader Error = %s", e.what());
...
//        const char *fShaderCode = fragmentCode.c_str();
    ...
    void setVec3Count(const std::string &name, int count,  const GLfloat *value) const {
...
#endif //OPENGLES3_0NDKDEMO_SHADER_H
